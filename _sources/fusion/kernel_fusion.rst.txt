...
The kernel helpers this module re-exports (``KernelSpec``, ``center_kernel``,
``normalize_kernel``, ``is_valid_kernel``) are documented once, in
:doc:`../utils/kernels`.

.. automodule:: polyview.fusion.kernel_fusion
   :members: KernelFusion
   :show-inheritance:
   :undoc-members: